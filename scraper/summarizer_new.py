...
class LLMProcessor:
    ...
    def analyze_entities(self, state):
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            Focus on extracting company information, key people, organizations,Contact Details, Phone Numbers,Locations and other relevant business details.
...
class EnhancedScraper:
    def __init__(self, openai_api_key=None):
        ...
        self.irrelevant_patterns = [
            ...
            # r'linkedin\.com/company',  # Company profile pages often lack detailed info
            ...
            # r'crunchbase\.com',        # May want to keep this for company info
    ...
    def filter_crawl_results(self, crawl_results, query):
        ...
        for result in crawl_results:
            ...
            if company_name not in title and company_name not in first_paragraph:
                ...
                if mentions_count < 3:
                    print(f"Skipping URL with few company mentions: {url}")
                    continue
            ...
            if score >= 3:
                ...
                print(f"Skipping low relevance URL: {url}")
...
if __name__ == "__main__":
    ...
    processed_results = scraper.scrape(company_name, max_results=20, output_file=output_file)
